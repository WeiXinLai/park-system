...
u5 = User('55555555', 'BigRed','123456','717334756@qq.coom','44528119960201242493','day',None,None,100)
...
stamp = str(int(time.mktime(date_end.timetuple())))
print date_end,stamp
print type(stamp)
...
db.session.commit()
db.session.add_all([u1,u2,u3,u4,u5,u6,u7,c1,c2,c3,c4,c5,c6,c7])
db.session.commit()
